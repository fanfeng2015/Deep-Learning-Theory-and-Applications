...
def model_fn(features, labels, mode):
    ...
    # Compare the use of mean-squared-error loss, cross entropy loss, and softmax log-likelihood loss
    ...
    loss_op = tf.losses.softmax_cross_entropy(onehot_labels=onehot_labels, logits=logits)
...
for epoch in range(5):
    ...
    e = model.evaluate(input_fn_train) # to get the train loss
    train_loss.append(e['loss'])
    e = model.evaluate(input_fn_test)  # to get the test accuracy
